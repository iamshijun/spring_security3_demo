...
--yahoo
--insert into users(username, password, enabled, salt) values ('https://me.yahoo.com/aimysaber#66ad4','unused',true,CAST(RAND()*1000000000 AS varchar));
--insert into group_members(group_id, username) select id,'https://me.yahoo.com/aimysaber#66ad4' from groups where group_name='Administrators';

--google
insert into users(username, password, enabled, salt) values ('https://plus.google.com/105659693545039944747','unused',true,CAST(RAND()*1000000000 AS varchar));
insert into group_members(group_id, username) select id,'https://plus.google.com/105659693545039944747' from groups where group_name='Administrators';
